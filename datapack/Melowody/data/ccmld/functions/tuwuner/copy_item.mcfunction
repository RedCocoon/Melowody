...
execute store success score @s ccmld.temp if data entity @s Inventory[{Slot:-106b}].tag.ccmld.instruments run item modify entity @s weapon.mainhand ccmld:tuwuner/copy_tuner
